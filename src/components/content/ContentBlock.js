...
export default function ContentBlock() {
    ...
    return (
        <div className="bg-gray-800 bg-opacity-40 firefox:bg-opacity-40 backdrop-filter backdrop-blur-sm text-white text-lg px-5 py-7 my-12 rounded-lg border border-gray-800 shadow-lg">
            { !text.loading ? 
            <>
