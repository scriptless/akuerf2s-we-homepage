...
export default function SubNavbar() {
    ...
    return (<>
        {items.length > 0 &&
        <div className="h-auto sticky top-0 bg-gray-800 bg-opacity-40 firefox:bg-opacity-40 backdrop-filter backdrop-blur-md shadow-lg border border-gray-800 border-opacity-10 w-full">
